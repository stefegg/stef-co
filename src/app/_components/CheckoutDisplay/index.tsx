...
export default function CheckoutDisplay() {
  ...
  return (
    <>
      {cart.length > 0 ? (
        <div
          className={`flex flex-col md:flex-row border-${appTheme}-text rounded-lg h-full gap-6`}
        >
          <div className="w-full md:w-2/3 rounded-lg flex flex-col shadow-[0px_0px_5px_5px_rgba(0,0,0,0.5)]">
            <div
            ...
            {!user ? (
              <div className="flex justify-center w-full pt-4 text-lg">
                <Link href="/login" className={`text-${appTheme}-link mr-2`}>
                  Login
                </Link>
